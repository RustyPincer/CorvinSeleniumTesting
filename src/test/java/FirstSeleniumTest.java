...
/**
 * FirstSeleniumTest contains test cases for various functionalities on the Corvin Mozi website.
 */
public class FirstSeleniumTest {
     ...
     *
     * @throws MalformedURLException if the URL for the RemoteWebDriver is incorrect.
     */
    @Before
    ...
    /**
     * Tests the form submission functionality with a user.
     */
    @Test
    ...
    /**
     * Tests that static pages load with the correct titles.
     */
    @Test
    ...
    /**
     * Logs in a user and returns the UserPage object.
     *
     * @param mainPage MainPage object to start the login process.
